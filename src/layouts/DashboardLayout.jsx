...
import { FaBorderAll, FaFortAwesomeAlt, FaRegCreditCard } from 'react-icons/fa6';
...
console.log(role);
  ...
  <div className="drawer-content">
    ...
    <nav className="navbar w-full bg-base-300">
      ...
      <div className="px-4">Local chef bazaar</div>
    </nav>
    {/* Page content here */}
  ...
  {/* profile page */}
        ...
        
    {
        ...
        {/*order requests  */}
        <li>
            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Order Requests" to ="/dashboard/order-requests">
           <FaBorderAll />
...

      {
        role.role === 'admin' && <>
         {/* manage request */}
        <li>
            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manage Request" to ="/dashboard/manage-request">
